...
contract TestNeufundTestToken {
  ...
  function testInitialBalanceWithNewNeufundTestToken() {
    ...
    Assert.equal(ntt.balanceOf(this), initialSupplyInEther * 1 ether, "Owner should have 10000 NeufundTestToken initially");
  }
  ...
  function testTransferTokens() {
    ...
    Assert.equal(ntt.balanceOf(this), (initialSupplyInEther - transferValueInEther) * 1 ether, "Owner should lose 100 tokens");
  }
